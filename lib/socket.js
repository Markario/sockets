...
function Socket(type, name, options){
	...
	setupZmq.call(this, options);
	setupWorkers.call(this, options);
	return this;
}
...
function setupWorkers(options){
	...
	let manualFlush = _.throttle(flush, options.manualFlushThrottle);
